...
<%request.setCharacterEncoding("UTF-8");%>
 <body>
    <p><h1 align="center">회원 가입</h1>
    <br>
    <FORM name="form"  action="joinProcess.jsp" method="post" onsubmit="return join();">
      <table width="50%" height="80" border="1" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr>
          ...
          <td> <input type="text" name="user_id" id="user_id" size="12" maxlength="12"> 4~12자의 영문 대소문자와 숫자로만 입력
          </td>
        </tr>
        <tr>
          <td>비밀번호</td>
          <td> <input type="password" name="user_pw" id="user_pw" size="12" maxlength="12"> 4~12자의 영문 대소문자와 숫자로만 입력
          </td>
        </tr>
        <tr>
          <td>비밀번호 확인</td>
        ...
        <tr>
          <td>메일주소</td>
          <td> <input type="text" name="email" id="email"> 예)id@domain.com
          </td>
        </tr>
        <tr>
          <td>이름</td>
        ...
        <tr>
          <td>생일 </td>
          <td> <input type="text" name="year" id="year" size="4" maxlength="4">년 
