...
implements IDao{
	...
	public ArrayList<ContentDto> listDao() {
		String query = "select * from myboard order by mId desc";
	...
	public void writeDao(final String mWriter, final String mContent) {
		...
		this.template.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(Connection con)
					throws SQLException {
				String query = "insert into myboard (mId, mWriter, mContent) values (board_seq.nextval, ?, ?)";
	...
	public ContentDto viewDao(String strID) {
		...
		String query = "select * from myboard where mId = " + strID;
	...
	public void deleteDao(final String bId) {
		...
		String query = "delete from myboard where mId = ?";
