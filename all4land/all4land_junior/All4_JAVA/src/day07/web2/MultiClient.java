...
public class MultiClient implements ActionListener {
    ...
    public MultiClient(String argIp, String argId) {
        ...
        jframe.setBackground(new Color(192, 192, 192));
    ...
    public static void main(String args[]) throws IOException {
        ...
        JFrame.setDefaultLookAndFeelDecorated(true); // jframe 실행
        
        System.out.println("user name input :");
        String name = sc.next();
        
        // 클라이언트 (아이피, 이름 ) -> 생성자 호출 -> jframe 실행
